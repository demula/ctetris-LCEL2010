...
// con versiones anteriores de la librer�a.
//-------------------------------------------------------------------
...
// 
// Descripci�n:
//  Configuraci�n del m�dulo de entrada/salida de 
//   prop�sito general del M5272 (GPIO) 
//
//-------------------------------------------------
void gpio_setup(void)
{  
  ...
  mbar_writeShort(MCFSIM_PBDDR, 0x0000); 	// S�lo afecta a PB5 y PB6 (in)
}
...
//
// Descripci�n:
//   Presenta un valor en los LEDs de informaci�n de la
//   placa Antares. 
//
...
//     |    ON    |    ON    |     ON     |     OFF    | 
// 
// Autor: Alberto Quintana Oca�a
//--------------------------------------------------------
void set_led(UWORD valor)
{
  UWORD puerto1_valor;	// Valor del puerto IO 1
  UWORD mascara;	// M�scara con el valor de los LEDs
